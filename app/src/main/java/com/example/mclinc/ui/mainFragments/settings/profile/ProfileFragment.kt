package com.example.mclinc.ui.mainFragments.settings.profile
...
import com.example.mclinc.databinding.FragmentProfileBinding
...
class ProfileFragment : Fragment() {
    ...
    private fun initViews() {
        binding.run {
            // Set user input listener for each EditText field
            nameEditText.setUserInputListener {
                profileViewModel.setUserName(it) // 'it' is the user input as String
            }
