...
import com.example.mclinc.R
import com.example.mclinc.base.ViewModelFactory
import com.example.mclinc.databinding.BottomsheetModalBinding
import com.example.mclinc.databinding.FragmentSettingsBinding
import com.example.mclinc.model.SettingsItem
import com.example.mclinc.model.SettingsState
import com.example.mclinc.ui.adapter.SettingsAdapter
import com.example.mclinc.ui.auth.signInScreen.SignInScreen
import com.example.mclinc.ui.mainFragments.settings.prescription.AddPrescriptionActivity
import com.example.mclinc.ui.mainFragments.settings.upi.UPImanager
import com.example.mclinc.ui.profile.ProfileActivity
import com.example.mclinc.utils.DialogUtil.createBottomSheet
import com.example.mclinc.utils.DialogUtil.setBottomSheet
...
//                        findNavController().navigate(R.id.action_settings_to_profileFragment)
    ...
    private fun aboutUs() {
        ...
        aboutUsDialog.apply {
            paragraphHeading.text = getString(R.string.welcome_to_mclinic)
